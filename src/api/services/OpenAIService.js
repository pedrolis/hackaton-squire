...
You MUST describe in english the script.
  ...
  async createVisualSegments(salesVideoPitch) {
   ...
   We want to generate a 30 second video based on the script below. The video should be divided into 6 segments of 5 seconds each. Propose 6 visuals for each of the 6 segments the video will have. YOU MUST AVOID the following types of visuals that image generation models struggle to generate: 
...
Use a format where each fragment of the script is associated with a description of visuals. It must be identical in structure and format to the following example from another different script.
 ...
 You MUST describe in english the script and the visuals.
